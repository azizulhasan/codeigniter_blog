            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  ...
                  <form id="needs-validation" action="<?php echo base_url().'blog/check'?>" method="post" encytyep='multipart/form-data'>
                    ...
                    <div class="form-group">
                      <select name="type" id="type" class="form-control">
                          ...
                          <option value="6">Advertiser</option>
                      </select>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    ...
                    <small class="text-muted mt-5 mb-1 d-block">Don't have an account? <a class="font-weight-bold " href="<?php echo base_url().'blog/register_subscriber';?>">Register Now!</a></small>
                  </div>
                  <div class="text-center">
                  </div>
                </div>
   ...
   console.log(value); 
		...
		$.ajax({
			...
			success: function (res) {
				if (res.data[0].email && res.data[0].type=='6') {
					window.location.assign(
						"https://blog.azizulhasan.com/"
					);
				} else {
					window.location.assign(
						"https://blog.azizulhasan.com/blog/login"
					);
				}
			},
			error: function (data) {
